...
application.get("/search", (request, response) => {
    db.then(connection => {
        ...
        response.render("pages/spa_with_search.ejs", {
            "data": result
        });
    }).catch(error => {
        console.log(error.message);
...
application.post("/api", (request, response) => {
    ...
    switch (request.body.mode) {
        ...
        case "search": person.searchRecord(db, lodash, request,response); break;
